...
<form action="#" method="POST" id="formail">
          <table width="550" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="padding-left:25px; padding-top:15px; padding-bottom:10px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px;"><strong>Kontakt</strong></span></td>
              </tr>
              <tr>
        ...
        <tr>
        	<td width="550">
              ...
              <tr>
                <td height="25" style="padding-left:25px;" valign="top"><label>Ihre Nachricht(*)</label></td>
