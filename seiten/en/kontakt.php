...
<script type="text/javascript" src="/<?= $WEBPATH ?>/scripte/kontakt.js?lang=en"></script>
...
<input type="hidden" id="versteckt" value="12_%r!Afq">
          <table width="550" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="padding-left:25px; padding-top:15px; padding-bottom:10px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size: x-large;"><strong>Contact</strong></span></td>
              </tr>
              <tr>
        ...
        <tr>
        	<td width="550">
                <table width="550" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="150" height="25" style="padding-left:25px;"><label>Surname, first name(*)</label></td>
                <td width="400"><input type="text" name="name" id="name" size="30" style="width:350px; height:15px;"/></td>
              </tr>
              <tr>
                <td height="25" style="padding-left:25px;"><label>Street</label></td>
                <td><input type="text" name="strasse" id="strasse" size="30" style="width:350px; height:15px;" /></td>
              </tr>
              <tr>
                <td height="25" style="padding-left:25px;"><label>Postcode/City</label></td>
              ...
              <tr>
                <td height="25" style="padding-left:25px;"><label>Phone(*)</label></td>
                <td><input type="text" name="telefon" id="telefon" size="30" style="width:350px; height:15px;" /></td>
              </tr>
              <tr>
                <td height="25" style="padding-left:25px;"><label>Mobile(*)</label></td>
                <td><input type="text" name="mobil" id="mobil" size="30" style="width:350px; height:15px;"/></td>
              </tr>
              <tr>
                <td height="25" style="padding-left:25px;padding-top:6px;" valign="top"><label>Your message(*)</label></td>
        ...
        <table width="550" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" style="padding-right:50px;"><input type="submit" id="submit" value="  Send  " />&nbsp;</td>
          </tr>
        </table>
        <table width="550" border="0" cellspacing="0" cellpadding="0">
              <tr>
