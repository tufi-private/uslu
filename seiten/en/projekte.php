...
<script type="text/javascript" src="/<?= $WEBPATH ?>/scripte/projekte.js.php?lang=en"></script>
...
$query = 'select * FROM content WHERE PageId = 12';
...
echo "<script language=\"javascript\">
		...
		/* Projektpunkte werden an Position bewegt */
			...
			$('#p_50').hide().animate({top : '360px', left : '150px'},2000).fadeIn(1000);
			$('#p_51').hide().animate({top : '360px', left : '210px'},2000).fadeIn(1000);
			$('#p_52').hide().animate({top : '360px', left : '270px'},2000).fadeIn(1000);
			$('#p_53').hide().animate({top : '360px', left : '330px'},2000).fadeIn(1000);
			$('#p_54').hide().animate({top : '420px', left : '150px'},2000).fadeIn(1000);
			$('#p_55').hide().animate({top : '420px', left : '210px'},2000).fadeIn(1000);
			$('#p_56').hide().animate({top : '420px', left : '270px'},2000).fadeIn(1000);
			$('#p_57').hide().animate({top : '420px', left : '330px'},2000).fadeIn(1000);
			$('#p_58').hide().animate({top : '420px', left : '390px'},2000).fadeIn(1000);
