...
jQuery.fn.jmp3 = function(passedOptions){
	// hard-wired options
	var playerpath = "../../sound/";					// SET THIS FIRST: path to singlemp3player.swf

	// passable options
	var options = {
		"filepath": "../../sound/",				// path to MP3 file (default: current directory)
		"backcolor": "ffffff",									// background color
		"forecolor": "ffffff",								// foreground color (buttons)
		"width": "25",										// width of player
		"repeatplay": "yes",										// repeat mp3?
		"volume": "30",										// mp3 volume (0-100)
	...
	return this.each(function(){
		...
		mp3html += '&repeatplay=' + options.repeatplay + '&songVolume=' + options.volume + '" />';
