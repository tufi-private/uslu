...
/* Menüpunkte werden an Position bewegt*/
	$("#m01_unternehmen").show().animate({top: "130px", left: "850px"},2000, function() {    
  ...
  $("#m01_unternehmen").click(function() {  
	...
	$("#m02_objekte").show().animate({top: "20px", left: "850px"},2000, function() {  
  ...
  $("#m05_impressum").click(function() {  
	...
	$("#m07_karriere").show().animate({top: "130px", left: "960px"},2000, function() {   
...
var c_wert = "130:850_20:850_20:270_130:160_130:270_130:960_220:160";
