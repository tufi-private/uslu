...
/* Menüpunkte werden an Position bewegt*/
  ...
  $("#m01_unternehmen").click(function() {  
	...
	$("#m02_objekte").show().animate({top: "160px", left: "150px"},2000, function() {  
  ...
  $("#m02_objekte").click(function() {  
	...
	$("#m03_projekte").show().animate({top: "50px", left: "270px"},2000, function() {    
  ...
  $("#m04_kontakt").click(function() {  
	...
	$("#m05_impressum").show().animate({top: "50px", left: "470px"},2000, function() {
  ...
  $("#m05_impressum").click(function() {  
	...
	$("#m07_karriere").show().animate({top: "50px", left: "570px"},2000, function() {   
...
var c_wert = "50:150_160:150_50:270_50:370_50:470_50:570_50:150";
