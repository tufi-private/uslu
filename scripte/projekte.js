...
/* Menüpunkte werden an Position bewegt*/
  ...
  $("#m01_unternehmen").click(function() {  
	...
	$("#m02_objekte").show().animate({top: "50px", left: "250px"},2000, function() {  
  ...
  $("#m02_objekte").click(function() {  
	...
	$("#m03_projekte").show().animate({top: "200px", left: "150px"},2000, function() {    
  ...
  $("#m03_projekte").click(function() {  
	...
	$("#m04_kontakt").show().animate({top: "50px", left: "350px"},2000, function() {   
  ...
  $("#m04_kontakt").click(function() {  
	...
	$("#m05_impressum").show().animate({top: "50px", left: "450px"},2000, function() {
  ...
  $("#m05_impressum").click(function() {  
	...
	$("#m07_karriere").show().animate({top: "50px", left: "550px"},2000, function() {   
