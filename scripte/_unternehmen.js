...
/* Menüpunkte werden an Position bewegt*/
	$("#m01_unternehmen").show().animate({top: "220px", left: "160px"},2000);
	$("#m02_objekte").show().animate({top: "20px", left: "160px"},2000);
	...
	$("#m07_karriere").show().animate({top: "220px", left: "270px"},2000);
	$("#m06_start").hide().css({top: "220px", left: "160px"},2000);

/* neue menü positionen in Cookie spiechern */
var c_name = "m_position";
var c_wert = "220:160_220:270_20:160_20:270_120:160_120:270_220:160";

createCookie(c_name,c_wert);


/* inhaltsblock definieren und mit inhalt befüllen*/
	$("#u_inhalt").animate({top:"+=20px", left:"+=370px"},1000).fadeIn(3000).load("../../seiten/de/content.php?table=pages&cnt=content&id=2").html();
