...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tfoot>
    <tr>
        <td colspan="6" class="rounded-foot-left"><em>Lorem ipsum dolor sit
    ...
    <tr>
        ...
        <td><a href="#">
            <img src="/<?= Bootstrap::getBasePath() ?>/img/user_edit.png" alt="" title=""
                 border="0"/></a></td>
        <td><a href="#" class="ask">
            <img src="/<?= Bootstrap::getBasePath() ?>/img/trash.png" alt=""
                 title="" border="0"/></a></td>
    </tr>
    ...
    <tr>
        ...
        <td><a href="#"><img src="/<?= Bootstrap::getBasePath() ?>/img/user_edit.png" alt="" title=""
                             border="0"/></a></td>
        <td><a href="#" class="ask"><img src="/<?= Bootstrap::getBasePath() ?>/img/trash.png" alt="" title="" border="0"/></a></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <a href="#"><img src="/<?= Bootstrap::getBasePath() ?>/img/user_edit.png" alt="" title="" border="0"/></a>
        </td>
        <td><a href="#" class="ask">
            <img src="/<?= Bootstrap::getBasePath() ?>/img/trash.png" alt="" title="" border="0"/></a></td>
    </tr>
...
<a href="#" class="bt_green"><span class="bt_green_lft"></span><strong>Add
    new item</strong><span class="bt_green_r"></span></a>
<a href="#" class="bt_blue"><span class="bt_blue_lft"></span><strong>View
    all items from category</strong><span class="bt_blue_r"></span></a>
<a href="#" class="bt_red"><span class="bt_red_lft"></span><strong>Delete
